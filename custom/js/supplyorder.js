	   	...
	   	for (var x = 0; x < quantity.length; x++) {       						
			...
			if(orderDate && clientName) {
				if(validateProduct == true && validateQuantity == true) {
	            	...
	            	'<a href="supplyorder.php?o=add" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> Add New Order </a>'+
...
function subAmount() {
	...
	// vat
	var vat = (Number($("#subTotal").val())/100) * 12;
	vat = vat.toFixed(2);
	$("#vat").val(vat);
	$("#vatValue").val(vat);
